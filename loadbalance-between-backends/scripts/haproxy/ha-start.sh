...
echo $projectBaseDir
docker run -d --name haproxy --ulimit nofile=4000150:4000150 --net server-network --expose 5555  -v ${projectBaseDir}/config:/usr/local/etc/haproxy:rw  -p 5555:5555 -p 80:80 -p 8404:8404 -p 8397:8397 --privileged -p 9999:9999 haproxytech/haproxy-debian:${VERSION}
